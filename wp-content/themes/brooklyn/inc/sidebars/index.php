...
if ( ! class_exists( 'UT_Sidebar_Settings' ) ) :
    ...
    class UT_Sidebar_Settings {
        ...
        public function add_menu_item() {
            add_submenu_page( 'themes.php' , 'Sidebar Settings' , 'Sidebar Settings' , 'publish_pages' , 'ut_sidebar_settings' ,  array( &$this , 'settings_page' ) );
        }
        ...
        public function register_settings() {
            ...
            // Add settings fields
            add_settings_field( 'ut_default_sidebar_align' , __( 'Blog Sidebar Align:' , 'ut_adelfox' ) , array( &$this , 'ut_default_sidebar_align' )  , 'ut_sidebar_settings' , 'main_settings' );            
            add_settings_field( 'ut_primary_default_sidebar' , __( 'Blog Primary Sidebar:' , 'ut_adelfox' ) , array( &$this , 'ut_primary_default_sidebar' )  , 'ut_sidebar_settings' , 'main_settings' );
            add_settings_field( 'ut_secondary_default_sidebar' , __( 'Blog Secondary Sidebar:' , 'ut_adelfox' ) , array( &$this , 'ut_secondary_default_sidebar' )  , 'ut_sidebar_settings' , 'main_settings' );
            
            /* woocommerce default sidebars - only show this set when plugin is active */
            if ( class_exists( 'woocommerce' ) ) {
            
                add_settings_field( 'ut_default_wocommerce_sidebar_align' , __( 'Woocommerce Sidebar Align:' , 'ut_adelfox' ) , array( &$this , 'ut_default_wocommerce_sidebar_align' )  , 'ut_sidebar_settings' , 'woo_settings' );            
                add_settings_field( 'ut_primary_wocommerce_default_sidebar' , __( 'Woocommerce Primary Sidebar:' , 'ut_adelfox' ) , array( &$this , 'ut_primary_wocommerce_default_sidebar' )  , 'ut_sidebar_settings' , 'woo_settings' );
                add_settings_field( 'ut_secondary_wocommerce_default_sidebar' , __( 'Woocommerce Secondary Sidebar:' , 'ut_adelfox' ) , array( &$this , 'ut_secondary_wocommerce_default_sidebar' )  , 'ut_sidebar_settings' , 'woo_settings' );
            
            }
            
            add_settings_field( 'ut_theme_sidebars' , __( 'Individual Sidebars:' , 'ut_adelfox' ) , array( &$this , 'ut_theme_sidebars' )  , 'ut_sidebar_settings' , 'unlimited_sidebars' );
        ...
        public function main_settings() { 
            ...
            //echo '<p>' . __( 'Manage Sidebars.' , 'ut_adelfox' ) . '</p>'; 
        ...
        public function ut_default_sidebar_align() {
            ...
            echo '<select class="postform" name="ut_default_sidebar_align" >';
                ...
                echo '<option value="none" ' . selected( 'none' , $data , false ) . '>' . __( 'No Sidebars', 'ut_adelfox'  ) . '</option>';
                echo '<option value="left" ' . selected( 'left' , $data , false ) . '>' . __( 'Sidebar Left', 'ut_adelfox'  ) . '</option>';
                echo '<option value="right" ' . selected( 'right' , $data , false ) . '>' . __( 'Sidebar Right', 'ut_adelfox'  ) .'</option>';
                echo '<option value="both" ' . selected( 'both' , $data , false ) . '>' . __( 'Sidebar Left and Right', 'ut_adelfox'  ) . '</option>';
            ...
            echo '<div id="ut-sidebars" class="ut-repeat-loop">';
                ...
                if( is_array( $data ) ) foreach ( (array)$data as $value ) {
                    ...
                    echo '<div class="widgets-holder-wrap closed ut-repeat-group">';
                        ...
                        echo '<div>';
                            ...
                            echo '<div class="widget-top"><div class="widget-title"><h4>' . __('Sidebar Name' , 'ut_adelfox') . '</h4></div></div>';
                            echo '<div class="widget-inside">';
                                
                                echo '<p><label>' . __('Please insert a unique name:' , 'ut_adelfox') . '<br />';
                            ...
                            echo '<div class="widget-top"><div class="widget-title"><h4>' . __('Description' , 'ut_adelfox') . ' </h4></div></div>';                            
                            echo '<div class="widget-inside">';
                            
                                echo '<p><label>' . __('optional description:' , 'ut_adelfox') . '<br />';
                ...
                echo '<div class="widgets-holder-wrap ut-repeat-group ut-to-copy">';
                    ...
                    echo '<div class="ut-sidebar-title sidebar-name">';
                        echo '<div class="sidebar-name-arrow"><br></div>';
                        echo '<h3>'; 
                            echo '<span>' . __('New Sidebar' , 'ut_adelfox') . '</span>';
                            echo '<span class="ut-dodelete dashicons dashicons-trash"></span>';
                        echo '</h3>';
                    echo '</div>';
                ...
                echo '<button class="ut-docopy button icon add">' . __('Add Sidebar', 'ut_adelfox') . '</button>';
        ...
        public function settings_page() {
            ...
            echo '<div id="ut-sidebar-manager" class="wrap">
                    ...
                    <h2 class="ut-settings-title">' . __('Sidebar Settings' , 'ut_adelfox') . '</h2>
                    <form method="post" action="options.php" enctype="multipart/form-data">';
                    
                    echo '<blockquote>' . __('These are your global sidebar settings, there is an option field for each post, where you can define your own custom sidebar settings for each post or page' , 'ut_adelfox') . '</blockquote>';
                        
                    settings_fields( 'ut_sidebar_settings' );
                    do_settings_sections( 'ut_sidebar_settings' );
    
                  echo '<p class="submit">
                            <input name="Submit" type="submit" class="button-primary" value="' . esc_attr( __( 'Save Settings' , 'ut_adelfox' ) ) . '" />
                        </p>
                    </form>
                  </div>';
        }
    ...
    $ut_ut_sidebar_settings = new UT_Sidebar_Settings( __FILE__ );
